...
```console
docker run cisagov/gatherer:2.0.6
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/gatherer:2.0.6
    ```
...
| --------- | ----------- |
| `cisagov/gatherer:2.0.6` | An exact release version. |
