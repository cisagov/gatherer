...
```console
docker run cisagov/gatherer:2.0.5
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/gatherer:2.0.5
    ```
...
| --------- | ----------- |
| `cisagov/gatherer:2.0.5` | An exact release version. |
