...
```console
docker run cisagov/gatherer:1.5.13
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/gatherer:1.5.13
    ```
...
|-----------|-------------|
|`cisagov/gatherer:1.5.13`| An exact release version. |
...
```console
docker build \
  --build-arg VERSION=1.5.13 \
  --tag cisagov/gatherer:1.5.13 \
