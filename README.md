...
```console
docker run cisagov/gatherer:1.5.14
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/gatherer:1.5.14
    ```
...
|-----------|-------------|
|`cisagov/gatherer:1.5.14`| An exact release version. |
...
```console
docker build \
  --build-arg VERSION=1.5.14 \
  --tag cisagov/gatherer:1.5.14 \
