...
```console
docker run cisagov/gatherer:1.5.1
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/gatherer:1.5.1
    ```
...
|-----------|-------------|
|`cisagov/gatherer:1.5.1`| An exact release version. |
