...
```console
docker run cisagov/gatherer:1.5.6
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/gatherer:1.5.6
    ```
...
|-----------|-------------|
|`cisagov/gatherer:1.5.6`| An exact release version. |
...
```console
docker build \
  --build-arg VERSION=1.5.6 \
  --tag cisagov/gatherer:1.5.6 \
