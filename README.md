...
```console
docker run cisagov/gatherer:1.5.3
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/gatherer:1.5.3
    ```
...
|-----------|-------------|
|`cisagov/gatherer:1.5.3`| An exact release version. |
